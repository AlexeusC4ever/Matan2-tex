...
\begin{document}
	\maketitle
	\section*{Вычислить бесконечное произведение как предел частичного.}
	%Task 1 
	\subsection*{Задача 1}
	\begin{flalign*}
		& \prod_{n=2}^{\infty} \left( 1 - \frac1{n^2} \right) \\
		& \text{Представим в виде бесконечной суммы:} \\
		& \prod_{n=2}^{\infty} \left( 1 - \frac1{n^2} \right) = 
		\text{\large $e^{\; \ln \prod \limits_{n=2}^{\infty} \left( 1 - \frac1{n^2} \right)} =
		e^{\; \sum \limits_{n=2}^{\infty} \ln \left( 1 - \frac1{n^2} \right)} $} \\
		& \text{Найдем значение частичной суммы:} \\
		& \sum_{n=2}^{N} \ln \left( 1 - \frac1{n^2} \right) = 
		\sum_{n=2}^{N} \ln \frac{n^2 - 1}{n^2} =
		\sum_{n=2}^{N} \left( (\ln (n - 1) - \ln n) - (\ln n - \ln (n + 1)) \right) = \\
		& = (\ln 1 - \ln 2) - (\ln N - \ln (N + 1)) = -\ln 2 + \ln \frac{N + 1}N \\
		& \text{Частичное произведение:} \\
		& \prod_{n=2}^{N} \left( 1 - \frac1{n^2} \right) = 
		\text{\large $e^{\; \sum \limits_{n=2}^{N} \ln \left( 1 - \frac1{n^2} \right)} =
		e^{-\ln 2 + \ln \frac{N + 1}N} $}  \\
		& \text{Бесконечное произведение как предел частичного:} \\
		& \prod_{n=2}^{\infty} \left( 1 - \frac1{n^2} \right) = 
		\lim_{N \to \infty} \text{\large $e^{-\ln 2 + \ln \frac{N + 1}N} =
		e^{-\ln 2 + \lim \limits_{N \to \infty}\ln \frac{N + 1}N} =
		e^{-\ln 2} = \frac12 $} \\[5 pt]
		& \text{ \fbox{ Ответ: $\displaystyle \prod_{n=2}^{\infty} \left( 1 - \dfrac1{n^2} \right) = \dfrac12$.} }
	\end{flalign*}
	
	%Task 2
	\subsection*{Задача 2}
	\begin{flalign*}
		& \prod_{n=1}^{\infty} e^{\frac{(-1)^n}n} \\
		& \text{Представим с помощью бесконечной суммы:} \\
		& \prod_{n=1}^{\infty} \text{\large $e^{\frac{(-1)^n}n} = 
		e^{\; \sum \limits_{n=1}^{\infty} \frac{(-1)^n}n} $} \\
		& \text{Найдем значение суммы:} \\
		& \sum \limits_{n=1}^{N} \frac{(-1)^n}n = 
		-\sum \limits_{n=1}^{N} \frac{(-1)^{n+1}}n = -\ln 2 \text{ (ряд Лейбница)}
		& \text{Бесконечное произведение:} \\
		& \prod_{n=1}^{\infty} \text{\large $e^{\frac{(-1)^n}n} = 
		e^{\; \sum \limits_{n=1}^{\infty} \frac{(-1)^n}n} = e^{-\ln 2} = \frac12 $} \\[5 pt]
		& \text{ \fbox{ Ответ: $\displaystyle \prod_{n=1}^{\infty} e^{\frac{(-1)^n}n} = \dfrac12$.} }
	\end{flalign*}
